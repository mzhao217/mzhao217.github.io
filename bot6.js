...
/*full access change starts */							
							...
							var myPanel = $('<div class="my_panel" style="left:15px;top:610px;"></div>'),
								myIcon = $('<img class="my_control" src="//mzhao217.github.io/my_icon.png"/>');
							a.panel1 = myPanel;
							$('body').append(myPanel);
							myPanel.append(myIcon);
							myPanel.draggable();
							...
							a.ngApp1 = angular.module("myPanel",[])
							a.templates = {
								"myPanel":"\u003Cdiv id \u003D app ng\u002Dapp \u003D \u0022myPanel\u0022 ng\u002Dcontroller \u003D \u0022myPanelController\u0022\u003E\u000A  \u003Cdiv\u003E\u000A    \u003Cinput type\u003D\u0022text\u0022 id\u003D\u0022input\u0022\u003E \u003C/input\u003E\u000A    \u003Cbutton ng\u002Dclick\u003D\u0022onSubmit1()\u0022\u003Eincre\u003C/button\u003E\u003Cspan\u003E\u000A\u003C/span\u003E\u000A    \u003Cbutton ng\u002Dclick\u003D\u0022onCloseClick(); return false;\u0022\u003Eclose\u003C/button\u003E\u000A  \u003C/div\u003E\u000A  \u003Cdiv id\u003D\u0022log\u0022\u003E\u003C/div\u003E\u000A \u003C/div\u003E\u000A",
...
/* end of modification */
		...
		PopMyPanel: function() {
			...
			if(dlg.length>0) dlg.remove();
				...
				box = $("body");
				if(bot.myPanelDlg) {
					bot.myPanelDlg.remove();
					bot.myPanelDlg = null;
					return;
				}
				if(box.length<1) return;
				var html = bot.templates.myPanel;
				bot.myPanelDlg = $(html);
				bot.myPanelDlg.draggable();
    ...
    //var app1 = angular.module('client',[]);
				bot.ngApp1.controller('myPanelController',function($scope) {
					...
					$scope.output = function(str) {
					  ...
					  $scope.ws.onmessage = function(e) {
						...
						$scope.output("onmessage: " + e.data);
					  };
					  
					  $scope.ws.onclose = function() {
						$scope.output("onclose");
					  };

					  $scope.ws.onerror = function(e) {
						$scope.output("onerror");
						console.log(e)
					  };
					...
					$scope.onSubmit1 = function() {
					  ...
					  $scope.ws.send(input.value);
					  $scope.output("send: " + input.value);
					  input.value = "";
					  input.focus();
					};
				...
				angular.bootstrap(bot.myPanelDlg, ["myPanel"]);
